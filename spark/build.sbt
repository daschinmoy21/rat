...
// The full JDK17 set Spark 3.5 recommends — the Hive/Hadoop clients reach into
// java.net, java.util and friends via reflection. Needed by runMain and by the
// SparkSession-backed specs alike (CorrelateSpec boots a local session).
val sparkJavaOptions = Seq(
  ...
  // single-DataNode stack: never ask for 3 replicas (matches
  // HDFS-SITE.XML_dfs.replication=1 on the NameNode)
